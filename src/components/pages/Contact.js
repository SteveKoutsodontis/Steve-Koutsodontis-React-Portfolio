...
export default function Contact() {
  return (
    <div class="contact">
      <h1>Contact Page</h1>
      <p>
        Please feel free to contact me at anytime. Through these links you will be able to Email, Check my Github, My LinkedIn and also download a copy of my resume.
      </p>
